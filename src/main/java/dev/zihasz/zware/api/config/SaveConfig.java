...
import dev.zihasz.zware.api.util.players.enemy.Enemy;
import dev.zihasz.zware.api.util.players.friends.Friend;
...
public class SaveConfig {
    ...
    public void saveCustomFont() throws IOException {
        ...
        fontObject.add("Font Name", new JsonPrimitive(ZWareMod.fontRenderer.getFontName()));
        fontObject.add("Font Size", new JsonPrimitive(ZWareMod.fontRenderer.getFontSize()));
